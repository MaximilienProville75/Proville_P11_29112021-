export const locations = [
  ...
  },
  {
    ...
    description:
      "Profitez du charme de la vie parisienne dans un magnifique appartement. A 3 minutes Ã  pied du Canl Saint Martin, vous serez proche des transports, mais Ã©galement de nombreux commerces. L'appartement est tout Ã©quipÃ©, et possÃ¨de Ã©galement un parking pour ceux qui souhaitent se dÃ©placer en voiture.",
    host: {
      name: "Della Case",
      picture:
  ...
  },
  {
    ...
    description:
      "Ã€ seulement deux pas des Buttes Chaumont, venez dÃ©couvrir Paris dans ce studio tout Ã©quipÃ©. EntiÃ¨rement Ã©quipÃ© pour votre confort et Ã©lÃ©gamment dÃ©corÃ©, il vous permettra de vivre comme un Parisien le temps de votre sÃ©jour.",
    host: {
      name: "Franck Maher",
      picture:
  ...
  },
  {
    ...
    description:
      "Ce loft entiÃ¨rement rÃ©novÃ©, et Ã©quipÃ© de meubles de luxe saura vous sÃ©duire. IdÃ©alement situÃ© dans le 10Ã¨me arrondissement, vous dÃ©placer dans Paris sera un vÃ©ritable jeu d'enfant.",
    host: {
      name: "Franck Maher",
      picture:
        "https://s3-eu-west-1.amazonaws.com/course.oc-static.com/projects/front-end-kasa-project/profile-picture-2.jpg",
  ...
  },
  {
    ...
    description:
      "Venez vous imprÃ©gner de la culture parisienne dans cet ancien studio d'artiste dÃ©corÃ© avec goÃ»t, au coeur de Montmartre.",
    host: {
      name: "Line Rolland",
      picture:
    ...
    equipments: ["Chambre SÃ©parÃ©e", "Parking"],
  ...
  },
  {
    ...
    description:
      "Ce Studio entiÃ¨rement fonctionnel sera votre parfait pied Ã  terre pour toutes vos excursions parisiennes. IdÃ©alement situÃ© prÃ¨s des lignes 2 et 4, vous accÃ©derez trÃ¨s rapidement Ã  tous les points touristiques de Paris.",
    host: {
      name: "Hugo Perrier",
      picture:
  ...
  },
  {
    ...
    tags: ["Luxe", "Tour Eiffel", "T3", "6Ã¨me"],
  },
  {
    id: "cb2f9222",
  ...
  },
  {
    ...
    tags: ["PÃ¨re Lachaise", "11e", "Metro 3", "Metro 2"],
  },
  {
    id: "2cf259e1",
    ...
    description:
      "SituÃ© en plein coeur du Marais, notre studio est idÃ©al pour les touristes en quÃªte de dÃ©couverte. Sa cuisine toute Ã©quipÃ©e est particuliÃ¨rement pratique.",
    host: {
      name: "Victor Moran",
      picture:
    ...
    rating: "4",
    location: "Ile de France - Paris 11e",
    equipments: ["Clic-clac", "Four", "SÃ¨che Cheveux", "Wi-fi"],
  ...
  },
  {
    ...
    description:
      "IdÃ©alement situÃ© Ã  2 pas de la place de la RÃ©publique, ce studio particuliÃ¨rement fonctionnel est parfait pour dÃ©couvrir Paris. Proche de tous les points d'intÃ©rÃªts grÃ¢ce aux 5 lignes de mÃ©tro qui sont Ã  5 minutes, vous pourrez rentabiliser votre temps passÃ© Ã  la capitale.",
    host: {
      name: "Sarah Devit",
      picture:
    ...
    tags: ["Marais", "RÃ©publique", "Studio", "Proche MÃ©tros", "Commerces"],
  },
  {
    id: "af6d2d48",
    ...
    tags: ["ForÃªt", "Nature", "MusÃ©e d'Ecouen"],
  },
  {
    id: "7cbb378e",
    ...
    description:
      "Vous chercher un endroit pour fÃªter un anniversaire entre amis tout en restant proche de Paris ? Ne cherchez plus ! EntiÃ¨rement Ã©quipÃ©e, cette maison est l'endroit idÃ©al pour se regrouper.",
    host: {
      name: "Karen Guillet",
      picture:
    ...
    tags: ["ForÃªt", "Nature", "Grande maison"],
  },
  {
    id: "ba55a0cc",
    title: "Maison T5 - Le Vàsinet",
    cover:
    ...
    description:
      "Maison T5. IdÃ©ale pour grands groupes. 45 minutes de Paris Saint-Lazare.",
    host: {
      name: "Karen Guillet",
      picture:
        "https://s3-eu-west-1.amazonaws.com/course.oc-static.com/projects/front-end-kasa-project/profile-picture-9.jpg",
  ...
  },
  {
    ...
    description:
      "Si vous Ãªtes Ã  la recherche de l'endroit idÃ©al pour poser vos valises entre deux rdvs d'affaire, ne cherchez plus. Notre loft est l'endroit idÃ©al. En plein coeur de la DÃ©fense, il dispose Ã©galement de tous les Ã©quipements pour que vous soyez comme chez vous.",
    host: {
  ...
  },
  {
    ...
    description:
      "Ce charmant appartement offre des prestations de luxe, aux portes de Paris. Ã€ deux pas de la ligne 3, vous pourrez accÃ©der Ã  toutes les attractions touristiques dont vous avez toujours rÃªvÃ©es.",
    host: {
      name: "Julie Donatella",
      picture:
        "https://s3-eu-west-1.amazonaws.com/course.oc-static.com/projects/front-end-kasa-project/profile-picture-10.jpg",
  ...
  },
  {
    ...
    description:
      "Cette chambre dispose de toutes les facilitÃ©s nÃ©cessaires. Proche mÃ©tro et commerces.",
    host: {
      name: "Hugo Perrier",
      picture:
        "https://s3-eu-west-1.amazonaws.com/course.oc-static.com/projects/front-end-kasa-project/profile-picture-4.jpg",
  ...
  },
  {
    ...
    description:
      "Ce studio dÃ©corÃ© avec goÃ»t sera votre nid douillet aprÃ¨s une longue journÃ©e passÃ©e Ã  dÃ©couvrir Paris.",
    host: {
      name: "Michel Romy",
      picture:
  ...
  },
  {
    ...
    description:
      "Au coeur du quartier historique du Marais, cet appartement est idÃ©al pour un couple Ã  la dÃ©couverte de Paris. SituÃ© sur la rue de Rivoli, il est Ã  5 minutes du Louvre.",
    host: {
      name: "Nathalie Jean",
      picture:
        "https://s3-eu-west-1.amazonaws.com/course.oc-static.com/projects/front-end-kasa-project/profile-picture-12.jpg",
